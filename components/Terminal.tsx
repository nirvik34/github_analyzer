export default function Terminal({ username, score }: { username: string; score: number }) {
    return (
        <div className="bg-white dark:bg-[#1e1e1e] border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-2xl relative z-10 w-full">
            <div className="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 px-4 py-3 flex items-center gap-2">
            ...
            <div className="p-6 font-mono text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300">
                <div className="flex gap-2 mb-2">
                    <span className="text-zinc-400">$</span>
                    <span className="text-black dark:text-white">analyze {username}</span>
                </div>
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-[10px] px-2 py-0.5 rounded bg-green-50 text-green-600 dark:bg-green-900/20 dark:text-green-400 font-bold uppercase">
                            Pass
                        </span>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-zinc-500 pt-2">
                            ...
                            <span className="text-black dark:text-white">84</span>
                        </div>
                        <div className="w-full bg-zinc-100 dark:bg-zinc-800 h-1 rounded-full overflow-hidden">
                            <div
                                className="bg-black dark:bg-white h-full"
